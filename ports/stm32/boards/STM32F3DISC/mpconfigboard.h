...
#define MICROPY_HW_ENABLE_USB       (0) //1

// HSE is 8MHz
//#define MICROPY_HW_CLK_PLLM (8)
//#define MICROPY_HW_CLK_PLLN (336)
//#define MICROPY_HW_CLK_PLLP (RCC_PLLP_DIV2)
//#define MICROPY_HW_CLK_PLLQ (7)		//disabled for testing
...
// CAN busses
//#define MICROPY_HW_CAN1_TX (pin_B9)	// No CAN for now
//#define MICROPY_HW_CAN1_RX (pin_B8)	// No CAN for  now
...
// LEDs
#define MICROPY_HW_LED6             (pin_E15) // green west
#define MICROPY_HW_LED8             (pin_E14) // orange south west
#define MICROPY_HW_LED10            (pin_E13) // red south
...
// USB config
#define MICROPY_HW_USB_FS              (0) // No USB
